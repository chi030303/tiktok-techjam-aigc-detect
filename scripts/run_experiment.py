#!/usr/bin/env python3
# 2026-08-29, tianqi, load a recipe, refuse forbidden train paths, print resolved dirs
"""Run one experiment from experiments/<name>/recipe.yaml."""
...
def main() -> None:
    ...
    print(f"  train:     {recipe.get('train', {}).get('datasets')}")
    print(f"  eval:      {recipe.get('eval')}")
