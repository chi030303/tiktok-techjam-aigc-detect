#!/usr/bin/env python3
# 2026-08-30, yun, exp3 entrypoint: RGB + frequency dual-branch recipes
"""Run one dual-branch experiment from experiments/<name>/recipe.yaml."""
...
def main() -> None:
    ...
    print(f"  dual_branch: {recipe.get('dual_branch')}")
